...
public class activity_login extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       db=new SQLiteHandler(getApplicationContext());
        ...
        if(session.isLoggedIn()){
            ...
            // user is aready logged in .move into main activity
            Intent i=new Intent(activity_login.this,main_category.class);
            startActivity(i);
            finish();;
    ...
    /**
     * function check to login in my sql database
     */
                ...
                try {
                    ...
                    if (!error) {
                       ...
                       JSONObject user = jObj.getJSONObject("user");
                        ...
                        db.addUser(namee, email, uid, created_at);
